...
# hence the lease_timeout is kept at 900s for headroom (max time a lock can be held for)
_company_sync_locks = RedisLockRegistry('hermes:company-lck', lease_timeout=900)
