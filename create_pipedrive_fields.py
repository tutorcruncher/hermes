...
ORGANIZATION_FIELDS = [
    ...
    {'name': 'utm_medium', 'field_type': 'text'},
    {'name': 'utm_term', 'field_type': 'text'},
    {'name': 'utm_content', 'field_type': 'text'},
    {'name': 'signup_email', 'field_type': 'text'},
    {'name': 'signup_phone', 'field_type': 'text'},
    {'name': 'signup_company_name', 'field_type': 'text'},
