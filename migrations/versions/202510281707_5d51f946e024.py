...
Revision ID: 5d51f946e024
Revises:
Create Date: 2025-10-28 17:07:52.675050
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['bdr_person_id'], ['admin.id'], ),
    sa.ForeignKeyConstraint(['sales_person_id'], ['admin.id'], ),
    sa.ForeignKeyConstraint(['support_person_id'], ['admin.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
    sa.Column('dft_entry_stage_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['dft_entry_stage_id'], ['stage.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['enterprise_pipeline_id'], ['pipeline.id'], ),
    sa.ForeignKeyConstraint(['payg_pipeline_id'], ['pipeline.id'], ),
    sa.ForeignKeyConstraint(['startup_pipeline_id'], ['pipeline.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
