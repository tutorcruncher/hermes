...
from app.models import Company, Admin, Config, Contact, CustomField, Deal, Pipeline
...
async def setup_database():
    ...
    await Admin.update_or_create(id=2, defaults={
    ...
    await Admin.update_or_create(id=1, defaults={
    ...
    await Admin.update_or_create(id=3, defaults={
    ...
    await Admin.update_or_create(id=4, defaults={
    ...
    await Admin.update_or_create(id=7, defaults={
    ...
    await Company.update_or_create(id=168, defaults={
        'name': "rake dog",
        'tc2_agency_id': 23,
    ...
    await Company.update_or_create(id=169, defaults={
    ...
    await Company.update_or_create(id=170, defaults={
        'name': "brave meraki",
        'tc2_agency_id': 25,
    ...
    await Company.update_or_create(id=166, defaults={
        'name': "123456",
        'tc2_agency_id': 21,
    ...
    await Company.update_or_create(id=167, defaults={
        'name': "infinite fork",
        'tc2_agency_id': 22,
    ...
    await Config.update_or_create(id=1, defaults={
        'meeting_dur_mins': 30,
    ...
    await Contact.update_or_create(id=125, defaults={
        'tc2_sr_id': 1291,
        'pd_person_id': 173,
    ...
    await Contact.update_or_create(id=126, defaults={
        'tc2_sr_id': 1352,
        'pd_person_id': 174,
    ...
    await Contact.update_or_create(id=127, defaults={
        'tc2_sr_id': 1413,
        'pd_person_id': 175,
    ...
    await Contact.update_or_create(id=128, defaults={
        'tc2_sr_id': 1474,
        'pd_person_id': 176,
    ...
    await Contact.update_or_create(id=124, defaults={
        'tc2_sr_id': 1230,
        'pd_person_id': 172,
    ...
    await CustomField.update_or_create(id=1, defaults={
        'name': "Website",
    ...
    await CustomField.update_or_create(id=2, defaults={
    ...
    await CustomField.update_or_create(id=3, defaults={
    ...
    await CustomField.update_or_create(id=4, defaults={
        'name': "TC2 Status",
    ...
    await CustomField.update_or_create(id=5, defaults={
        'name': "UTM Source",
    ...
    await CustomField.update_or_create(id=6, defaults={
        'name': "UTM Campaign",
    ...
    await CustomField.update_or_create(id=7, defaults={
    ...
    await Deal.update_or_create(id=160, defaults={'pd_deal_id': 225, 'name': '123456', 'status': 'open', 'admin_id': 1,
                                                  'company_id': 166, 'contact_id': 124, 'pipeline_id': 1,
                                                  'stage_id': 1})
    await Deal.update_or_create(id=161,
                                defaults={'pd_deal_id': 227, 'name': 'infinite fork', 'status': 'open', 'admin_id': 1,
                                          'company_id': 167, 'contact_id': 125, 'pipeline_id': 1, 'stage_id': 1})
    await Deal.update_or_create(id=162,
                                defaults={'pd_deal_id': 229, 'name': 'rake dog', 'status': 'open', 'admin_id': 1,
                                          'company_id': 168, 'contact_id': 126, 'pipeline_id': 1, 'stage_id': 1})
    await Deal.update_or_create(id=163,
                                defaults={'pd_deal_id': 230, 'name': 'xenogenesis yearn spoon', 'status': 'open',
                                          'admin_id': 1, 'company_id': 169, 'contact_id': 127, 'pipeline_id': 2,
                                          'stage_id': 9})
    await Deal.update_or_create(id=164,
                                defaults={'pd_deal_id': 231, 'name': 'brave meraki', 'status': 'open', 'admin_id': 1,
                                          'company_id': 170, 'contact_id': 128, 'pipeline_id': 1, 'stage_id': 1})
    ...
    await Pipeline.update_or_create(id=3,
                                    defaults={'pd_pipeline_id': 6, 'name': 'ENTERPRISE', 'dft_entry_stage_id': 10})
...
async def run():
    # Initialize Tortoise
    await Tortoise.init(
        db_url='postgres://postgres@localhost:5432/hermes',
